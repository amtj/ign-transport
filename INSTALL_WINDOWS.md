...
1. Download the following things into that directory:
    ...
    - [Protobuf 2.6.0-win32](http://packages.osrfoundation.org/win32/deps/protobuf-2.6.0-win32-vc12.zip)
    - [Protobuf 2.6.0-win64](http://packages.osrfoundation.org/win32/deps/protobuf-2.6.0-win64-vc12.zip)
